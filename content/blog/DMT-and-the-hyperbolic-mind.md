...
- [[2026-03-19-dmt-as-the-orthogonal-api-key]] *(score: 0.84)* — 
- [[taoism-quantum-physics-controversy]] *(score: 0.86)* — Semantic overlap detected at 0.
- [[the-hyperbolic-geometry-of-dmt-experiences-v2]] *(score: 0.92)* — These documents converge on modeling the phenomenology of DMT-induced consciousness as a traversal of hyperbolic hypersp.
- [[the-hyperbolic-geometry-of-dmt-experiences]] *(score: 0.97)* — These ideas intersect through the shared application of hyperbolic geometry to model transhuman intelligence, connecting.
- [[the-hyperbolic-geometry-of-dmt-experiences-v3]] *(score: 0.99)* — These texts construct DMT phenomenology as a traversal of hyperbolic geometry, directly mapping Terence McKenna's citati.
