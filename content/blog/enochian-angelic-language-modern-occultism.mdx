...
images:
  ...
  - src: "/images/blog/enochian-angelic-language-modern-occultism/image-5.webp"
    caption: "The Heptarchy — seven earths of the angelic hierarchy"
    position: "after-the-heptarchy-seven-earths"
  - src: "/images/blog/enochian-angelic-language-modern-occultism/image-6.webp"
    caption: "The Scrying Mirror — angels emerging from obsidian darkness"
...
For those drawn to go deeper into the practice itself — the 48 Calls, the angelic hierarchy and the ritual keys — [browse the Enochian Magick Archive here](/shop/etsy-4308981590).
