        ...
        <div className="flex items-center gap-4">
          ...
          {auth.isAuthenticated ? (
            <div className="relative" ref={dropdownRef}>
              ...
              >
                <div className="w-11 h-11 rounded-full bg-[#7B5EA7] flex items-center justify-center text-white text-sm font-bold uppercase border border-[var(--primary-gold)]/30">
